					...
					<div class="container">
						...
						<div class="mry-portfolio-frame">
							<div class="mry-masonry-grid">
								...
								<div class="mry-masonry-grid-item mry-masonry-grid-item-50 mry-masonry-grid-item-h-x-2 architecture">
								...
								<div class="mry-masonry-grid-item mry-masonry-grid-item-50 mry-masonry-grid-item-h-x-2 interior architecture">
