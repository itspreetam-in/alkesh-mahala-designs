...
<div  class="transition-fade">
			<div class="mry-content-frame" id="scroll">
				...
				<div class="mry-head-bg">
					<img src="assets/img/light/projects/prjct-6/1.jpg" alt="background">
									...
									<div class="mry-masonry-grid mry-without-descr mry-p-0-100">
										...
										<div class="mry-masonry-grid-item mry-masonry-grid-item-50 interior">
											...
											<div class="mry-card-item">
												<div class="mry-card-cover-frame mry-mb-20 mry-fo">
													<img src="assets/img/light/projects/prjct-1/1.jpg" alt="project" >
													<div class="mry-cover-overlay"></div>
													<div class="mry-hover-links">
														<a href="assets/img/light/projects/prjct-1/fs/1.jpg" data-fancybox="works" class="mry-zoom mry-magnetic-link"><span class="mry-magnetic-object"><i
										...
										<div class="mry-masonry-grid-item mry-masonry-grid-item-50 mry-masonry-grid-item-h-x-2 repair">
											...
											<div class="mry-card-item">
												<div class="mry-card-cover-frame mry-mb-20 mry-fo">
													<div class="mry-cover-overlay"></div>
													<img src="assets/img/light/projects/prjct-1/4.jpg" alt="project" >
													<div class="mry-hover-links">
														<a href="assets/img/light/projects/prjct-1/fs/4.jpg" data-fancybox="works" class="mry-zoom mry-magnetic-link"><span class="mry-magnetic-object"><i
																	class="fas fa-expand"></i></span></a>
													</div>
												</div>
											</div>
										...
										<div class="mry-masonry-grid-item mry-masonry-grid-item-50 interior repair">
											...
											<div class="mry-card-item">
												<div class="mry-card-cover-frame mry-mb-20 mry-fo">
													<img src="assets/img/light/projects/prjct-1/3.jpg" alt="project" >
													<div class="mry-cover-overlay"></div>
													<div class="mry-hover-links">
														<a href="assets/img/light/projects/prjct-1/fs/3.jpg" data-fancybox="works" class="mry-zoom mry-magnetic-link"><span class="mry-magnetic-object"><i
																	class="fas fa-expand"></i></span></a>
													</div>
												</div>
											</div>
										...
										<div class="mry-masonry-grid-item mry-masonry-grid-item-50 mry-masonry-grid-item-h-x-2 interior">
											...
											<div class="mry-card-item">
												<div class="mry-card-cover-frame mry-mb-20 mry-fo">
													<img src="assets/img/light/projects/prjct-1/6.jpg" alt="project" >
													<div class="mry-cover-overlay"></div>
													<div class="mry-hover-links">
														<a href="assets/img/light/projects/prjct-1/fs/6.jpg" data-fancybox="works" class="mry-zoom mry-magnetic-link"><span class="mry-magnetic-object"><i
																	class="fas fa-expand"></i></span></a>
													</div>
												</div>
											</div>
										...
										<div class="mry-masonry-grid-item mry-masonry-grid-item-50 interior">
											...
											<div class="mry-card-item">
												<div class="mry-card-cover-frame mry-mb-20 mry-fo">
													<img src="assets/img/light/projects/prjct-1/2.jpg" alt="project" >
													<div class="mry-cover-overlay"></div>
													<div class="mry-hover-links">
														<a href="assets/img/light/projects/prjct-1/fs/2.jpg" data-fancybox="works" class="mry-zoom mry-magnetic-link"><span class="mry-magnetic-object"><i
																	class="fas fa-expand"></i></span></a>
													</div>
												</div>
											</div>
										...
										<div class="mry-masonry-grid-item mry-masonry-grid-item-50 interior">
											...
											<div class="mry-card-item">
												<div class="mry-card-cover-frame mry-mb-20 mry-fo">
													<img src="assets/img/light/projects/prjct-1/fs/5.jpg" alt="project" >
													<div class="mry-cover-overlay"></div>
													<div class="mry-hover-links">
														<a href="assets/img/light/projects/prjct-1/fs/5.jpg" data-fancybox="works" class="mry-zoom mry-magnetic-link"><span class="mry-magnetic-object"><i
																	class="fas fa-expand"></i></span></a>
													</div>
												</div>
											</div>
									...
									<div class="swiper-wrapper">
										<div class="swiper-slide">
											...
											<div class="mry-card-item">
												<div class="mry-card-cover-frame mry-mb-20 mry-fo">
													...
													<div class="mry-cover-overlay"></div>
													<div class="mry-hover-links">
														<a href="assets/img/light/projects/prjct-1/fs/1.jpg" data-fancybox="works-slider" class="mry-zoom mry-magnetic-link"><span
										...
										<div class="swiper-slide">
											...
											<div class="mry-card-item">
												<div class="mry-card-cover-frame mry-mb-20 mry-fo">
													<div class="mry-badge">interior</div>
													<img src="assets/img/light/projects/prjct-2/1.jpg" alt="project" >
													<div class="mry-cover-overlay"></div>
													<div class="mry-hover-links">
														<a href="assets/img/light/projects/prjct-2/fs/1.jpg" data-fancybox="works-slider" class="mry-zoom mry-magnetic-link"><span
																class="mry-magnetic-object"><i class="fas fa-expand"></i></span></a>
														<a href="project.html" class="mry-more mry-magnetic-link mry-anima-link"><span class="mry-magnetic-object"><i
																	class="fas fa-arrow-right"></i></span></a>
													</div>
										...
										<div class="swiper-slide">
											...
											<div class="mry-card-item">
												<div class="mry-card-cover-frame mry-mb-20 mry-fo">
													<div class="mry-badge">interior</div>
													<img src="assets/img/light/projects/prjct-3/1.jpg" alt="project" >
													<div class="mry-cover-overlay"></div>
													<div class="mry-hover-links">
														<a href="assets/img/light/projects/prjct-3/fs/1.jpg" data-fancybox="works-slider" class="mry-zoom mry-magnetic-link"><span
																class="mry-magnetic-object"><i class="fas fa-expand"></i></span></a>
														<a href="project.html" class="mry-more mry-magnetic-link mry-anima-link"><span class="mry-magnetic-object"><i
																	class="fas fa-arrow-right"></i></span></a>
													</div>
										...
										<div class="swiper-slide">
											...
											<div class="mry-card-item">
												<div class="mry-card-cover-frame mry-mb-20 mry-fo">
													<div class="mry-badge">interior</div>
													<img src="assets/img/light/projects/prjct-4/1.jpg" alt="project" >
													<div class="mry-cover-overlay"></div>
													<div class="mry-hover-links">
														<a href="assets/img/light/projects/prjct-4/fs/1.jpg" data-fancybox="works-slider" class="mry-zoom mry-magnetic-link"><span
																class="mry-magnetic-object"><i class="fas fa-expand"></i></span></a>
														<a href="project.html" class="mry-more mry-magnetic-link mry-anima-link"><span class="mry-magnetic-object"><i
																	class="fas fa-arrow-right"></i></span></a>
													</div>
				...
				<footer class="mry-footer">
					<div class="container">
						<div class="mry-main-title mry-title-center mry-p-0-100">
							...
							<h2 class="mry-h1 mry-mb-20 mry-fo">We still have a lot of <br><span class="mry-border-text">interesting things!</span></h2>
							<div class="mry-text mry-mb-30  mry-fo">Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br>Asperiores, cupiditate?</div>
							<div class="mry-fo">
								<a href="project.html" class="mry-anima-link mry-btn mry-btn-color mry-default-link">Next Project</a>
				...
				<div class="mry-head-bg mry-head-bottom">
					<img src="assets/img/light/projects/prjct-2/1.jpg" alt="background">
					<div class="mry-bg-overlay"></div>
				</div>
